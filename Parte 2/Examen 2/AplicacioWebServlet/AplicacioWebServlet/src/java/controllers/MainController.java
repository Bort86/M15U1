...
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet MainController at " + request.getParameter("username") + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
    ...
    private void escriuNom(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        //response.sendRedirect("response.jsp?nom="+name+"&numero=4");
       ...
       //recollint i donant nom a totes les variables de sessió
        ...
        //no cal enviar res perquè totes les variables
        //de sessió estan gravades al servidor
