...
public class Patient {
    ...
    public Patient(int idRegistre, int edat, String grupEdat, int pes, int talla, double imc, String classificacio, int menarquia, String menopausia, String tipusMenopausia) {
